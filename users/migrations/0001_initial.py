    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documents', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='general.documents')),
                ('doljnost', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='users.doljnost')),
